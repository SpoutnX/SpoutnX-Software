...
windowPrecess_Periastre.setFixedSize(QSize(400, 450))

windowPrecess_Geodetic = QStackedWidget()
windowPrecess_Geodetic.setParent(windowCaracteristics)
windowPrecess_Geodetic.setFixedSize(QSize(400, 500))
...
# PRECESSION GEODETIQUE -- CARACTERISTIQUES
        ...
        if c == L[104]:
            ...
            label1.setParent(windowPrecess_Geodetic)
            ...
            labAlt.setParent(windowPrecess_Geodetic)
            labAlt.move(50, 70)
            ...
            entAlt = QLineEdit()
            entAlt.setParent(windowPrecess_Geodetic)
            entAlt.move(100, 100)
            ...
            spinboxMass.setParent(windowPrecess_Geodetic)
            ...
            labTitle3.setParent(windowPrecess_Geodetic)
            ...
            labVit.setParent(windowPrecess_Geodetic)
            labVit.move(50, 320)
            ...
            entVit = QLineEdit()
            entVit.setParent(windowPrecess_Geodetic)
            entVit.move(70, 350)
            ...
            spinboxMc.setParent(windowPrecess_Geodetic)
            ...
            btnValid_Geodetic = QPushButton(L[11])
            btnValid_Geodetic.setParent(windowPrecess_Geodetic)
            btnValid_Geodetic.move(155, 450)
            btnValid_Geodetic.setFixedSize(QSize(90, 30))
            font65 = btnValid_Geodetic.font()
            font65.setPointSize(12)
            btnValid_Geodetic.setFont(font65)
            btnValid_Geodetic.pressed.connect(recupdata11)
            btnValid_Geodetic.show()

            # Calcul du moment cinétique__________________________________
            ...
            btnMomentCinetic.setParent(windowPrecess_Geodetic)
            btnMomentCinetic.move(180, 400)
            ...
            windowMomentCinetic.setParent(windowPrecess_Geodetic)
...
# PRECESSION DU PERIASTRE -- CARACTERISTIQUES
        ...
        if c == L[148]:
            ...
            labTitle.setParent(windowPrecess_Periastre)
            labTitle.move(70, 5)
            ...
            labEx.setParent(windowPrecess_Periastre)
            labEx.move(50, 160)
            ...
            entEx = QLineEdit()
            entEx.setParent(windowPrecess_Periastre)
            entEx.move(100, 190)
            ...
            labA.setParent(windowPrecess_Periastre)
            labA.move(50, 250)
            ...
            entA = QLineEdit()
            entA.setParent(windowPrecess_Periastre)
            entA.move(100, 280)
            ...
            spinbox.setParent(windowPrecess_Periastre)
