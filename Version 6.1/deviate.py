...
windowShapiro = QWidget()
winShapiroResults.setWindowTitle("Résultats")
winShapiroResults.setFixedSize(QSize(600, 450))
winShapiroResults.setWindowIcon(QIcon('/usr/lib/spoutnx/icone2.ico'))

windowAberration = QWidget()
windowAberration.setWindowTitle("Résultats")
windowAberration.setFixedSize(QSize(600, 450))
windowAberration.setWindowIcon(QIcon('/usr/lib/spoutnx/icone2.ico'))
...
# RESULTATS SHAPIRO
    ...
    if ty4 == 6 and ty == 2:
        ...
        winShapiroResults.setParent(winShapiroResults)
        winShapiroResults.setFixedSize(QSize(600, 450))
        ...
        def ReturnDat():
            winShapiroResults1.hide()
            winShapiroResults.deleteLater()

            photondeviate()

        btnReturn = QPushButton(L[108])
        btnReturn.setParent(window7)
        btnReturn.move(10, 300)
        btnReturn.setFixedSize(QSize(150, 25))
...
windowCaracteristiques.setWindowIcon(QIcon('/usr/lib/spoutnx/icone2.ico'))
...
# CARACTERISTIQUES ABERRATION
    ...
    listeChoice.setFixedSize(QSize(350, 100))
