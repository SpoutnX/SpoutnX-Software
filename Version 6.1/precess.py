...
def swarsResults9():
    ...
    windowResults_Geodetic.setWindowIcon(QIcon('/usr/lib/spoutnx/icone2.ico'))
    ...
    windowResults_Periastre.setWindowIcon(QIcon('/usr/lib/spoutnx/icone2.ico'))
